...
urlpatterns = [
    ...
    path('dashboard/student/roomBook/history/',views.room_booking_history , name='room_booking_history'),
    path('dashboard/student/roomBook/<int:booking_id>/cancel/',views.cancel_room_booking,name='cancel_room_booking'),
